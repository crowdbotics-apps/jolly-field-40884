"""
Django settings for jolly_field_40884 project.
...
ROOT_URLCONF = 'jolly_field_40884.urls'
...
WSGI_APPLICATION = 'jolly_field_40884.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jolly_field_40884 API",
    "DESCRIPTION": "API documentation for jolly_field_40884 App",
    "VERSION": "v1",
}
